<template>
  <div class="perback">
    ...
    <div class="personaltitle">
      ...
      <div class="box-shadow" style="border-radius: 12px;margin-bottom: 14px;">
        <div>
          <p>
          ...
          <p>
            <el-button type="primary" @click="recharge">{{$t('m.Personal.Center3')}}</el-button>
            <el-button type="primary" @click="withdraw">{{$t('m.Personal.Center4')}}</el-button>
          </p>
        </div>
        <div>
          <ul class="f-flex" >
		...
		<div class="persoaltask f-flex" style="flex-wrap: wrap;">
		  <div  v-for="(item,index) in user.task_grade_count" :key="index">
    ...
    <!-- </div> -->
    <!-- 更多功能 -->
	<div class="or-lin" style="height: 4px;"></div>
    <div class="more">
	  ...
	  <p class="or-lin" style="height: 4px;"></p>
	  ...
	  <div class="f-flex f-jc-sb" @click="selection(14)">
	    <p class="f-flex">
	      <van-icon name="cart-circle" />
	  ...
	  <div class="f-flex f-jc-sb" @click="selection(12)">
	    <p class="f-flex">
	      <van-icon name="cart-circle" />
	      <span>购买记录</span>
	    </p>
    ...
    <div class="exit">
      <el-button type="primary" @click="displayout">{{$t('m.Personal.Center17')}}</el-button>
    </div>

    <!-- 退出提示框 -->
    <div class="outBox_mask" v-if="outbox">
        <div class="outbox">
          <p class="out_Tips">{{$t('m.Personal.Center22')}}</p>
          <div class="out_btn_box">
            <p class="cancel" @click="hideout">{{$t('m.Personal.Center24')}}</p>
            <p class="determine" @click="exit">{{$t('m.Personal.Center23')}}</p>
          </div>
        </div>
    </div>
  </div>
  ...
  methods: {
    ...
    selection(e) {
      ...
      if(e==10){
	    ...
	    if(e == 12){
		    location.href=`${this.host}/app/index.php?i=4&c=entry&do=consume&m=weliam_indiana`
	    }
      if(e==13){
